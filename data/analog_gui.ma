...
//Name: analog_gui.ma
//Last modified: Wed, Apr 10, 2024 04:39:00 PM
//Codeset: 936
requires maya "2022";
requires -nodeType "lsController" "lsr" "0.0.41.0_7226db4 build@[20:52:10 Jan 16 2024]";
...
fileInfo "UUID" "4B98E3A1-495D-C5F5-BDAE-178505DC68B0";
createNode transform -s -n "persp";
	rename -uid "1F733D66-48BC-F36A-95F0-85B776379FF9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.097300561285095 163.57238785723217 65.511808473264765 ;
	setAttr ".r" -type "double3" -6.9383527299770504 -26.999999999999975 2.2310124807733124e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 1000;
	setAttr ".coi" 40.142054591602026;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.006649732589718127 158.72317366409303 30.006907105445862 ;
...
createNode transform -n "GRP_C_eyesAim";
	rename -uid "19FF5AC7-4135-E624-005F-9F93D3F39419";
...
createNode transform -n "CTRL_C_eyesAim" -p "GRP_C_eyesAim";
	rename -uid "3B6931AF-4714-DA74-7B6E-19A827773A3C";
	addAttr -ci true -sn "nodezoo_custom_type" -ln "nodezoo_custom_type" -dt "string";
	addAttr -ci true -sn "nodezoo_marking_menu" -ln "nodezoo_marking_menu" -dt "string";
	setAttr -l on ".nodezoo_custom_type" -type "string" "LSCtrl";
	setAttr -l on -cb on ".nodezoo_marking_menu" -type "string" "lsr_rig_marking_menu";
createNode lsController -n "CTRL_C_eyesAimShape" -p "CTRL_C_eyesAim";
	rename -uid "4E4A6419-4365-5BF0-093F-0594B0483C97";
	setAttr -k off ".v";
	setAttr ".los" -type "double3" 3 1 7 ;
	setAttr ".bmin" -type "float3" -2.1213202 -4.1835665e-31 -4.9497476 ;
	setAttr ".bmax" -type "float3" 2.1213202 4.1835665e-31 4.9497476 ;
	setAttr ".lr" -type "double3" 0 0 1.1299600123008403e-29 ;
	setAttr ".st" 2;
createNode transform -n "GRP_R_eyeAim" -p "CTRL_C_eyesAim";
	rename -uid "36E489F3-4FB5-2365-F47E-02913D04E5A6";
	setAttr ".t" -type "double3" 0.071119262695304997 0 -2.933106899261487 ;
createNode transform -n "CTRL_R_eyeAim" -p "GRP_R_eyeAim";
	rename -uid "3613BE4C-4872-E9C2-65E4-78B22AAFC330";
	addAttr -ci true -sn "nodezoo_custom_type" -ln "nodezoo_custom_type" -dt "string";
	addAttr -ci true -sn "nodezoo_marking_menu" -ln "nodezoo_marking_menu" -dt "string";
	setAttr -l on ".nodezoo_custom_type" -type "string" "LSCtrl";
	setAttr -l on -cb on ".nodezoo_marking_menu" -type "string" "lsr_rig_marking_menu";
createNode lsController -n "CTRL_R_eyeAimShape" -p "CTRL_R_eyeAim";
	rename -uid "1B915BB7-48F1-0F8A-83C7-139B16E7FDC7";
	setAttr -k off ".v";
	setAttr ".bmin" -type "float3" -0.99862951 0 -0.99862951 ;
	setAttr ".bmax" -type "float3" 0.99862951 0 0.99862951 ;
	setAttr ".clr" -type "float3" 1 1 0 ;
createNode transform -n "GRP_L_eyeAim" -p "CTRL_C_eyesAim";
	rename -uid "ADB1B299-4459-FDA3-A032-11BBB9CC6A1D";
	setAttr ".t" -type "double3" -0.042848632812507503 0 2.9223375320434446 ;
createNode transform -n "CTRL_L_eyeAim" -p "GRP_L_eyeAim";
	rename -uid "72F990D8-42DA-3935-71E3-21ACA653691A";
	addAttr -ci true -sn "nodezoo_custom_type" -ln "nodezoo_custom_type" -dt "string";
	addAttr -ci true -sn "nodezoo_marking_menu" -ln "nodezoo_marking_menu" -dt "string";
	setAttr -l on ".nodezoo_custom_type" -type "string" "LSCtrl";
	setAttr -l on -cb on ".nodezoo_marking_menu" -type "string" "lsr_rig_marking_menu";
createNode lsController -n "CTRL_L_eyeAimShape" -p "CTRL_L_eyeAim";
	rename -uid "6379BDAA-4081-562B-4D99-ECA6D418DF97";
	setAttr -k off ".v";
	setAttr ".bmin" -type "float3" -0.99862951 0 -0.99862951 ;
	setAttr ".bmax" -type "float3" 0.99862951 0 0.99862951 ;
	setAttr ".clr" -type "float3" 1 1 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4D9DBE5A-4BF7-B21B-9CF0-98B0036B184F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "F01C08D5-49A5-43AB-5F29-158C839BA2FC";
createNode displayLayer -n "defaultLayer";
	rename -uid "8C781950-4A38-A1E6-7DB9-C9AE66742526";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4D203EB6-40FF-B8D4-B4D3-B58CEE16C4D2";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A1A51553-4C15-F6BC-8DEC-83833188AADB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F750793D-4286-11E8-248C-BA9F0D9D5DDE";
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -av -k on ".fzn";
